...
class AnimTool_Visual_Studio_ExtentionWindowPane :
	public CComObjectRootEx<CComSingleThreadModel>,
	public VsWindowPaneFromResource<AnimTool_Visual_Studio_ExtentionWindowPane, IDD_AnimTool_Visual_Studio_Extention_DLG>,
	public VsWindowFrameEventSink<AnimTool_Visual_Studio_ExtentionWindowPane>,
...
{
	VSL_DECLARE_NOT_COPYABLE(AnimTool_Visual_Studio_ExtentionWindowPane)

protected:

	// Protected constructor called by CComObject<AnimTool_Visual_Studio_ExtentionWindowPane>::CreateInstance.
	AnimTool_Visual_Studio_ExtentionWindowPane() :
...
BEGIN_COM_MAP(AnimTool_Visual_Studio_ExtentionWindowPane)
...
BEGIN_MSG_MAP(AnimTool_Visual_Studio_ExtentionWindowPane)
...
END_MSG_MAP()
	...
	{
		VsWindowFrameEventSink<AnimTool_Visual_Studio_ExtentionWindowPane>::SetSite(GetVsSiteCache());
...
class AnimTool_Visual_Studio_ExtentionToolWindow :
	public VSL::ToolWindowBase<AnimTool_Visual_Studio_ExtentionToolWindow>
{
public:
	...
	AnimTool_Visual_Studio_ExtentionToolWindow(const PackageVsSiteCache& rPackageVsSiteCache):
	...
	IUnknown* GetViewObject()
	{
		...
		CComObject<AnimTool_Visual_Studio_ExtentionWindowPane>* pViewObject;
		VSL_CHECKHRESULT(CComObject<AnimTool_Visual_Studio_ExtentionWindowPane>::CreateInstance(&pViewObject));
