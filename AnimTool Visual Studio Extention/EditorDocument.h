...
[$RootKey$\KeyBindingTables\{21f14660-cce5-41b3-adbc-a3ca7073073a}]
@="#1"
...
AnimTool_Visual_Studio_ExtentionUI.vsct, to work correctly so that the appropriate command handler below will be
called.
...
class EditorDocument : 
	...
	public IDispatchImpl<ISingleViewEditor, &__uuidof(ISingleViewEditor), &LIBID_AnimTool_Visual_Studio_ExtentionLib>,
...
VSL_BEGIN_COMMAND_MAP()
	...
	VSL_COMMAND_MAP_ENTRY(CLSID_AnimTool_Visual_Studio_ExtentionCmdSet, commandIDStrike, &OnQueryStrikeOut, &OnStrikeOut)
...
// Data members
	...
	VsMacroRecorder<&CLSID_AnimTool_Visual_Studio_ExtentionEditorDocument, LastMacro, eLastMacroNone> m_Recorder;
