...
/***************************************************************************
AnimTool Visual Studio Extention.pkgdef contains:


[$RootKey$\Editors\{cd1f0015-218b-4d83-a58e-1297c34309ec}]
@="AnimTool Visual Studio Extention"
"Package"="{ffaf760b-a8b7-425c-83c5-b50df1b0854b}"
"DisplayName"="AnimTool Visual Studio Extention"
"ExcludeDefTextEditor"=dword:00000001
"AcceptBinaryFiles"=dword:00000000

[$RootKey$\Editors\{cd1f0015-218b-4d83-a58e-1297c34309ec}\LogicalViews]
"{7651A703-06E5-11D1-8EBD-00A0C90F26EA}"=""

[$RootKey$\Editors\{cd1f0015-218b-4d83-a58e-1297c34309ec}\Extensions]
"animtool visual studio extention"=dword:00000032

which informs the shell that AnimTool_Visual_Studio_ExtentionPackage is the package to create to have this editor 
registered with Visual Studio.  When AnimTool_Visual_Studio_ExtentionPackage is sited by Visual Studio, 
AnimTool_Visual_Studio_ExtentionPackage::PostSited creates an instance of EditorFactory and then queries
...
#pragma warning(pop)
		...
		VSEDITORCREATEDOCWIN& /*rCreateDocumentWindowUI*/)
	{
		if(physicalViewId == Primary)
		{
			...
			rpguidCommandUI = &CLSID_AnimTool_Visual_Studio_ExtentionEditorDocument;
